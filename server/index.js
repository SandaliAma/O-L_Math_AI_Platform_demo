...
console.log(
  `   JWT_SECRET loaded: ${
    process.env.JWT_SECRET
      ? "✅ Yes (" + process.env.JWT_SECRET.substring(0, 10) + "...)"
      : "❌ No"
  }`
);
console.log(
  `   GROQ_API_KEY loaded: ${process.env.GROQ_API_KEY ? "✅ Yes" : "❌ No"}`
);
console.log(
  `   MONGODB_URI loaded: ${process.env.MONGODB_URI ? "✅ Yes" : "❌ No"}`
);
...
app.post("/api/gemini", async (req, res) => {
  try {
    ...
    console.log(
      "🤖 Gemini endpoint - Received question:",
