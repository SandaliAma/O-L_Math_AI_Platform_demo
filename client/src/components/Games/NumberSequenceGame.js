  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-purple-600">{score}</p>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 sm:p-12 text-center mb-4 sm:mb-6">
          {feedback && (
          ...
          {!feedback && (
            <>
              ...
              <input
                ...
                className="text-2xl sm:text-3xl md:text-4xl font-bold text-center border-4 border-purple-300 rounded-lg px-4 sm:px-6 py-3 sm:py-4 focus:outline-none focus:border-purple-500 w-full max-w-[200px] sm:w-48 touch-manipulation"
                autoFocus
                placeholder="?"
                inputMode="numeric"
              />
